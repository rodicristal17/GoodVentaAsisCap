...
-- Sincroniza la interfaz X-GT-1-JMTG-V1.90 sin eliminar versiones anteriores.
...
SELECT
    'X-GT-1-JMTG-V1.90',
    'Mejoras del flujo de trabajos de laboratorio dental y estabilidad operativa',
    '2026-07-24',
    'Inactivo'
FROM DUAL
WHERE NOT EXISTS (
...
UPDATE historialactualizacion
SET detalles = 'Mejoras del flujo de trabajos de laboratorio dental y estabilidad operativa',
    fecha = '2026-07-24',
    estado = 'Activo'
...
-- Validacion esperada: una sola version activa con codigo X-GT-1-JMTG-V1.90.
