...
paginaPie += "<div style='width: 50%;'><table class='tableRegistroSearch2' style='width:100%'>"
	...
	+"<tr>"
		+"<td style='text-align:left;border: 1px solid rgb(206, 206, 206);'>"
		+"<p class='pTituloC'>Transferencia</p>"
		+"</td>"
		+"<td style='width:20%;text-align:right;border: 1px solid rgb(206, 206, 206);'>"
	...
	+"<tr>"
		+"<td style='text-align:left;border: 1px solid rgb(206, 206, 206);'>"
		+"<p class='pTituloC'><b>Sumatoria total</b></p>"
		+"</td>"
		+"<td style='width:20%;text-align:right;border: 1px solid rgb(206, 206, 206);'>"
		+"<p class='pTituloC' ><b>"+ totalIngreso.toString().replace(/\B(?=(\d{3})+(?!\d))/g, '.') +"</b></p>"
		+"</td>"
		+"<td style='width:20%;text-align:right;border: 1px solid rgb(206, 206, 206);'>"
		+"<p class='pTituloC' ><b>"+ totalEgreso.toString().replace(/\B(?=(\d{3})+(?!\d))/g, '.') +"</b></p>"
		+"</td>"
	+"</tr>"
+"</table></div>";
/*
