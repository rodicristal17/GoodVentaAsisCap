...
UPDATE historialactualizacion SET codigo='X-GT-1-JMTG-V1.62', detalles='Mensajes del sistema implementados', fecha='2026-02-20' WHERE idhistorialactualizacion= 2;
