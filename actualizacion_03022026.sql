...
UPDATE historialactualizacion SET codigo='X-GT-1-JMTG-V1.81', detalles='Historial de pacientes implementado', fecha='2026-05-08' WHERE idhistorialactualizacion= 2;
-- Cargar permisos
